...
class TestEmployeeIndexView:
    ...
    # Employeeを対象とするルールを持たない権限セットのユーザーには一覧が0件になること
...
class TestEmployeeCreateView:
    ...
    # 管理者が有効なデータでPOSTすると社員が作成され詳細ページにリダイレクトされること
    ...
    # 社員番号が既に使われている場合、エラー付きでフォームが再表示されること
...
class TestEmployeeEditView:
    ...
    # 管理者が有効なデータでPOSTすると氏名が更新され、パスワード未入力なら変更されないこと
    ...
    # 他人の社員番号に変更しようとすると、エラー付きでフォームが再表示され更新されないこと
