...
class TestTaskListPage:
    ...
    # タスクが存在しない場合、「タスクがありません。」と表示されること
...
class TestTaskAccessControl:
    ...
    # 未ログインでタスク一覧にアクセスするとログインページにリダイレクトされること
...
class TestTaskCreatePage:
    ...
    # タスクを新規作成すると詳細ページにリダイレクトされ、成功メッセージが表示されること
...
class TestTaskEditPage:
    ...
    # タスクを編集すると詳細ページにリダイレクトされ、成功メッセージが表示されること
...
class TestTaskDeletePage:
    ...
    # タスクを削除すると一覧ページにリダイレクトされ、成功メッセージが表示されること
